 ...
 * @author Zhuyuhang
 */
@WebServlet("/unFollowAlbum")
public class UnFollowAlbumServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        albumFollowService.unFollowAlbum(Integer.valueOf(user_id), Integer.valueOf(album_id));
    }
