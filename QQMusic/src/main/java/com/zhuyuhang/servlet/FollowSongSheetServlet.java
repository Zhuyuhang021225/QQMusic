 ...
 * @author Zhuyuhang
 */
@WebServlet("/followSongSheet")
public class FollowSongSheetServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        songSheetFollowService.followSongSheet(Integer.valueOf(user_id), Integer.valueOf(songSheet_id));
    }
